...
write.csv(data ,file="Cerebellum/Enrichment/Grouped_CRBLM_Gene_enrichment.csv")
```


```{r}
tiff(file = 'Cerebellum/Enrichment/CRBLM_grouped_gene_enrichment.tiff', units="in", width=8, height=5, res=1000)
...
data<-data.frame(CRBLM_groups)
write.csv(data ,file="Cerebellum/Enrichment/Grouped_CRBLM_KEGG_enrichment.csv")
```


```{r}
tiff(file = 'Cerebellum/Enrichment/CRBLM_grouped_kegg_enrichment.tiff', units="in", width=8, height=5, res=1000)
dot5<-dotplot(CRBLM_groups,showCategory=3, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
...
data<-data.frame(CRBLM_groups)
write.csv(data ,file="Cerebellum/Enrichment/Grouped_CRBLM_Disease_enrichment.csv")
```


```{r}
tiff(file = 'Cerebellum/Enrichment/CRBLM_grouped_disease_enrichment.tiff', units="in", width=8, height=5, res=1000)
dot6<-dotplot(CRBLM_groups_DO,showCategory=3, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
...
```{r}
CRBLM_big<- dot4/dot5/dot6

tiff(file = 'Cerebellum/Enrichment/CRBLM_dot_plots_big.tiff', units="in",width=10, height=15, res=500)

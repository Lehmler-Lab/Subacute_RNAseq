...
rn6_ref<-TxDb.Rnorvegicus.UCSC.rn6.refGene #gene model is the RN6 rat genome
rn6_ref
```
...
file.exists(filenames) #a sanity check to make sure you have files named correctly
```

...
```{r}
tiff(file = "Striatum/heatmap/Male_heatmap.tiff", units="in", width=8, height=5, res=1000)
heat<- pheatmap(mat, 
         annotation_col=df,
...
#***volcano plots***
```{r}
tiff(file = 'Striatum/volcano_plots/M_volcano_plot_CRBLM.tiff', units="in", width=8, height=5, res=1000)
...
```{r}
tiff(file = "Striatum/heatmaps/Female_heatmap.tiff", units="in", width=8, height=5, res=1000)
heat<- pheatmap(mat, 
         annotation_col=df,
...
write.csv(data,file="Striatum/Enrichment/Male_STN_gene_enrichment.csv")
```


```{r}
tiff(file = 'Striatum/Enrichment/Male_Striatum_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot1<-dotplot(Mgse, 
              showCategory=5, 
              split=".sign") +
  geom_point(shape = 1,
...
```{r}
data<-data.frame(DO)
write.csv(data ,file="Striatum/Enrichment/Male_STN_disease_enrichment.csv")
```

```{r}
tiff(file = 'Striatum/Enrichment/Male_STN_disease_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot17<-dotplot(DO,showCategory=5, 
               split=".sign") +
  geom_point(shape = 1,
             colour = "black") +
  scale_color_viridis(option = "inferno", 
...
write.csv(data,file="Striatum/Enrichment/Male_STN_KEGG_enrichment.csv")
```


```{r}
tiff(file = 'Striatum/Enrichment/Male_Striatum_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot2<-dotplot(Mkk2, 
              showCategory=5, 
              split=".sign") +
  geom_point(shape = 1,
...
```{r}
male_STN_big<- dot1|dot2|dot17

tiff(file = 'Striatum/Enrichment/male_STN_big.tiff', units="in", width=28, height=5.75, res=500)
male_STN_big
dev.off()
```
...
write.csv(data ,file="Striatum/Enrichment/female_STN_gene_enrichment.csv")
```

```{r}
tiff(file = 'Striatum/Enrichment/Female Striatum_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot3<-dotplot(Fgse, 
              showCategory=5, 
              split=".sign") +
  geom_point(shape = 1,
...
```{r}
data<-data.frame(DO)
write.csv(data ,file="Striatum/Enrichment/Female_STN_disease_enrichment.csv")
```

```{r}
tiff(file = 'Striatum/Enrichment/Female_STN_disease_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot18<-dotplot(DO,
               showCategory=5, 
               split=".sign") +
  geom_point(shape = 1,
...
write.csv(data ,file="Striatum/Enrichment/female_STN_KEGG_enrichment.csv")
```


```{r}
tiff(file = 'Striatum/Enrichment/Female Striatum_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot4<-dotplot(Fkk2,
              showCategory=5,
              split=".sign") +
  geom_point(shape = 1,
...
```{r}
Female_STN_big<- dot3|dot4|dot18

tiff(file = 'Striatum/Enrichment/Female_STN_big.tiff', units="in", width=28, height=5.75, res=500)
Female_STN_big
dev.off()
```
